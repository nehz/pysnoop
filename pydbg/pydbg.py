...
from my_ctypes  import * #@UnusedWildImport
from defines    import * #@UnusedWildImport
from windows_h  import * #@UnusedWildImport
...
from memory_breakpoint       import * #@UnusedWildImport
from memory_snapshot_block   import *
from memory_snapshot_context import *
from pdx                     import * #@UnusedWildImport
from system_dll              import * #@UnusedWildImport
...
class pydbg:
    ...
    def read_process_memory (self, address, length):
        ...
        try:
            ...
            print kernel32.GetLastError(), hex(address), _length
            pass
    ...
    #MODIFY
    def call_func(self, address, pid):
        h_process = kernel32.OpenProcess(PROCESS_ALL_ACCESS, False, pid)        
        kernel32.CreateRemoteThread(h_process, None, 0, address, 0, 0, None)   
